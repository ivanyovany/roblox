...
Arquitectura: FSM Estricta, DEAD terminal, recovery estable y BURST sellado seguro d
...
trackConnection(topBar.InputBegan:Connect(beginDrag))
trackConnection(title.InputBegan:Connect(beginDrag))
...
trackConnection(btnCopy.MouseButton1Click:Connect(function()
...
trackConnection(btnToggle.MouseButton1Click:Connect(function()
...
trackConnection(btnAction.MouseButton1Click:Connect(function()
    local char, hrp, hum = FSM:GetValidEntity()
